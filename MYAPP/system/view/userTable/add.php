...
<body>    
            ...
            <table style="table-layout:fixed;">
                <tr>
                    ...
                    <td style="width:150px;">
                        <input name="userid" id="userid" class="mini-textbox" required="true"/>
                    </td>
                ...
                <tr>
                    <td>密码：</td>
                    <td>
                        <input name="password" class="mini-password" vtype="minLength:6" required="true" minLengthErrorText="密码不能少于6个字符" />
                    </td>
					<td>电话：</td>
                    <td>
	...
	<script>
        ...
        function SaveData() {
            ...
            $.ajax({
                url: "index.php?m=system&c=userTable&a=add",
		        type: 'post',
                data: { data: json },
				dataType:'json',
                cache: false,
