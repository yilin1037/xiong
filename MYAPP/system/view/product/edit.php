...
<body>    
    ...
    <form id="form1" method="post">
        ...
        <div style="padding-left:11px;padding-bottom:5px;">
            <table style="table-layout:fixed;">
                ...
                <tr>
                    ...
                    <td class="hd">件条码</td>
                    <td>
                        <input name="box_barcode" class="mini-textbox" value="<?=$show['box_barcode']?>" required />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="hd">件长</td>
                    <td style="width:100px;">
                        <input id="box_length" name="box_length" class="mini-textbox" style="width:70px;" onvaluechanged="computeVolume()" value="<?=$show['box_length']?>" /> <em class="tips">m</em>
                    </td>
                    <td class="hd">件宽</td>
                    <td style="width:100px;">
                        <input id="box_width" name="box_width" class="mini-textbox" style="width:70px;" onvaluechanged="computeVolume()" value="<?=$show['box_width']?>"/> <em class="tips">m</em>
                    </td>
                </tr>
                <tr>
                    <td class="hd">件高</td>
                    <td style="width:100px;">
                        <input id="box_height" name="box_height" class="mini-textbox" style="width:70px;" onvaluechanged="computeVolume()" value="<?=$show['box_height']?>" /> <em class="tips">m</em>
                    </td>
                    <td class="hd">件体积</td>
                    <td style="width:100px;">
                        <input id="box_volume" name="box_volume" class="mini-textbox" style="width:70px;" value="<?=$show['box_volume']?>" /> <em class="tips">m</em>
                    </td>
                    <td class="hd">件换算率</td>
                    <td style="width:100px;">
        ...
        <input type="mini-hidden" name="id" class="mini-hidden" value="<?=$show['status']?>" />
