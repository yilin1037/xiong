...
<body>    
    ...
    <form id="form1" method="post">
        ...
        <div style="padding:5px;">
            <table style="table-layout:fixed;">
				<tr>
                    <td style="width:80px;">区域编号：</td>
                    <td style="width:150px;">    
                        <input name="area_no" id="wh_no" class="mini-textbox" required="true" />
                    </td>
                    <td style="width:80px;">区域名称：</td>
                    <td style="width:150px;">
						<input name="area_name" class="mini-textbox" required="true" />
                    </td>
                </tr>
    ...
    <script type="text/javascript">
        ...
        function SaveData() {
			...
			//alert(json);eixt;
            $.ajax({
                url: "index.php?m=system&c=wh&a=addArea",
		        type: 'post',
                data: { data: json },
				dataType:'json',
                cache: false,
