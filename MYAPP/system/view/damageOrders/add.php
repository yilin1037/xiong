...
<body> 
			...
			<table style="table-layout:fixed;">
				<tr>
					...
					<td style="width:150px;">
						<input class="mini-buttonedit" required="true" onbuttonclick="onSelectDealer" id="dealer_no" name="dealer_no" allowInput="false"/>
					</td>
					...
					<td style="width:150px;">
						<input name="wh_no" class="mini-combobox" url="index.php?m=system&c=wh&a=getwhList" textField="wh_name" valueField="wh_no" emptyText="请选择..."/>
					</td>
				</tr>
				<tr>
	...
	<script>
        ...
        function SaveData() {
            ...
            $.ajax({
                url: "index.php?m=system&c=damageOrders&a=add",
		        type: 'post',
		...
		grid.on("cellcommitedit", function (e){
			...
			{
				e.row['add_unit_num'] = Math.ceil(e.value*(e.row['box_rate']) ? e.row['box_rate'] : 1);
