            ...
            <table style="table-layout:fixed;">
            	<tr>
                    ...
                    <td style="width:150px;">    
                        <input name="user_no" id="user_no" class="mini-textbox" value="<?=$show['user_no']?>" emptyText=""/>
                    </td>
                ...
                <tr>
                    ...
                    <td style="width:150px;">    
                        <input name="user_name" id="user_name" class="mini-textbox" required emptyText="" value="<?=$show['user_name']?>" />
                    </td>
                ...
                <tr>
                    <td >电话：</td>
                    <td>    
                        <input name="mobile" class="mini-textbox" required value="<?=$show['mobile']?>" />
                    </td>
                    <td>所属角色：</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>职务名称：</td>
                    <td>    
                        <input name="job" class="mini-textbox" required value="<?=$show['job']?>" />
                    </td>
                </tr>
