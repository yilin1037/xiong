		...
		<table style="table-layout:fixed;">
			<tr>
				...
				<td style="width:150px;">
					<input class="mini-buttonedit" onbuttonclick="onSelectDealer" id="dealer_no" name="dealer_no" required="true" />
				</td>
				<!--<td style="width:80px;">调出类型：</td>
				<td style="width:150px;">
					<input name="is_operator" class="mini-combobox" data="[{'id':'0','text':'同价调拨'},{'id':'1','text':'异价调拨'}]" valueField="id" textField="text" emptyText="请选择" />
				</td>-->
			</tr>
			<tr>
	...
	<div class="mini-fit" style="background:white;height:300px;">
		<div id="datagrid1" class="mini-datagrid" style="width:100%;height:300px" url="" multiSelect="true" allowCellEdit="true" allowAlternating="true" allowCellSelect="true" idField="id" showPager="false">
			<div property="columns">
				...
				<div field="add_box_num" width="60" headerAlign="center" align="center" allowSort="">件数量
					<input property="editor" class="mini-textbox" style="width:100%;"/>
				</div>
...
<script>
	...
	function SaveData() {
		...
		$.ajax({
			url: "index.php?m=system&c=moveOrder&a=add",
			type: 'post',
	...
	grid.on("drawcell", function (e) {
		...
		if(field == "prd_no" || field == "add_unit_num" || field == "add_unit_num1" || field == "add_box_num" || field == "remark" || field=="out_loc_no" || field=="in_loc_no"){
