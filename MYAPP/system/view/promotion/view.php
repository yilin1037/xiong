		...
		<div class="head-box" style="padding-left:11px;padding-bottom:5px;">
			...
			<table style="table-layout:fixed;width:830px">
				<tr>
					...
					<td style="width:120px">
						<p class="p_box"><?php echo date("Y-m-d ",$show['addtime']);?></p>
					</td>
					<td style="width:10px"></td>
					<td style="width:120px">    
						<input name="is_multiple" class="mini-checkbox" id="is_multiple" text="是否倍数赠送" trueValue="1" falseValue="0" value="<?php echo $show['is_multiple'] ;?>" />
					</td>
				</tr>
			</table>
