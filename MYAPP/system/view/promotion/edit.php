...
<body> 
	...
	<form id="form1" method="post">
		...
		<div class="head-box" style="padding-left:11px;padding-bottom:5px;">
			...
			<table style="table-layout:fixed;width:830px">
				<tr>
					...
					<td style="width:120px">
						<input name="sales_name" class="mini-textbox" value="<?php echo $show['sales_name'];?>"/>
					</td>
					<td style="width:50px">制单日期：</td>
					<td style="width:120px">
						<input id="addtime" name="addtime" class="mini-datepicker" value="new Date()" value="<?php echo $show['addtime'];?>"/>
					</td>
					<td style="width:10px"></td>
					<td style="width:120px">    
						<input name="is_multiple" id="is_multiple" class="mini-checkbox" text="是否倍数赠送" trueValue="1" falseValue="0" value="<?php echo $show['is_multiple'];?>" />
					</td>
				</tr>
			</table>
			...
			<table style="width:600px">
				<tr>
                    ...
                    <td style="width:120px;">    
                        <input id="begin_date" name="begin_date" class="mini-datepicker" value="new Date()" value="<?php echo $show['begin_date'];?>"/>
                    </td>
					<td style="width:65px;">结束日期：</td>
                    <td style="width:120px;">
						<input id="end_date" name="end_date" class="mini-datepicker" value="new Date()" value="<?php echo $show['end_date'];?>"/>
                    </td>
                </tr>
			</table>
		...
		<div class="mini-fit" style="background:white;height:300px;">
			<div id="grid" class="mini-datagrid" style="width:99%;height:100%;" allowCellEdit="true" allowCellSelect="true" showPager="false" idField="id" url="index.php?m=system&c=promotion&a=getItemList&sales_no=<?=$show['sales_no']?>">
                ...
                <div style="width:100%;">
                    <div class="mini-toolbar" style="border-bottom:0;padding:0px;">
                        <table style="width:100%;">
                            <tr>
                                <td style="width:100%;">
                                    <a class="mini-button" iconCls="icon-add" onClick="onAdd('grid2')">增加</a>
                                    <a class="mini-button" iconCls="icon-remove" onClick="onRemove('grid2')">删除</a>
                                </td>
                            </tr>
                        </table>
                    </div>
	...
	<script>
        ...
        function SaveData() {
			...
			//console.log(dataItem);return;
			//var json2 = mini.encode(rowData);
			$.ajax({
                url: "index.php?m=system&c=promotion&a=edit",
		        type: 'post',
