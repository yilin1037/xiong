...
<body>
            ...
            <table style="table-layout:fixed;">
                <tr>
                    ...
                    <td style="width:150px;">
                        <input name="handing_no" class="mini-textbox" textField="true" enabled="false" value="<? echo $show['handing_no'];?>" />
                    </td>
                    <td style="width:80px;">名称：</td>
                    <td style="width:150px;">
                        <input name="handing_name" id="handing_name" class="mini-textbox" required="true" emptyText="装卸队名称" value="<? echo $show['handing_name'];?>" />
                    </td>
                </tr>
                <tr>
					<td style="width:80px;">联系人：</td>
                    <td style="width:150px;">    
                        <input name="linkman" class="mini-textbox" required="true" value="<?=$show['linkman']?>" />
                    </td>
                ...
                <tr>
					...
					<td colspan="3">    
						<input name="remark" class="mini-textarea" style="width:430px" value="<? echo $show['remark'];?>" />
					</td>
				</tr>  
	...
	<script>
        ...
        function SaveData() {
            ...
            $.ajax({
                url: "index.php?m=system&c=handingTeam&a=edit",
		        type: 'post',
                data: { data: json },
				dataType:'json',
                cache: false,
